...
describe('BigInputActionComponent', () => {
  ...
  it('should be created', () => {
    const template = '<budega-big-input-action></budega-big-input-action>';
  ...
  it('should disable button if disabled property is set', () => {
    const template =
      '<budega-big-input-action [disabled]="true"></budega-big-input-action>';
    fixture = createHostComponent(template);
  ...
  it('should display icon if fontSet and fontIcon properties are set', () => {
    const template =
      '<budega-big-input-action fontSet="fas" fontIcon="fa-trash"></budega-big-input-action>';
    fixture = createHostComponent(template);
  ...
  it('should display label with provided text when label property is set', () => {
    const template =
      '<budega-big-input-action label="delete"></budega-big-input-action>';
    fixture = createHostComponent(template);
  ...
  it('should emit action event on button click', () => {
    const template =
      '<budega-big-input-action (action)="actionHandler()"></budega-big-input-action>';
    fixture = createHostComponent(template);
